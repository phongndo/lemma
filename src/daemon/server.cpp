...
[[nodiscard]] auto run_owned_server(const std::string& path, const ServeOptions options) noexcept
  ...
  reactor_environment.pause_pane_hydration_for_test = options.pause_pane_hydration_for_test;
  reactor_environment.snapshot_worker_test_hook = options.snapshot_worker_test_hook;
  reactor_environment.snapshot_directory = options.snapshot_directory;
