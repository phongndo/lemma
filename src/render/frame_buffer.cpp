...
[[nodiscard]] auto compose_retained_frame(
    const std::span<const PaneSurface> panes, const Viewport viewport, FrameBuffer& frame,
    const bool force_full, const StatusLine status, const PaneOverlay overlay,
